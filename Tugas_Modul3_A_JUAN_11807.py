...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1807</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\dimas\Documents\Semester 5\PMDPM\Model Suprevised Learning (Praktek)\Tugas3_A_11807'
    ...
    if os.path.exists(model_path):
        ...
        mtk4 = st.sidebar.number_input("Nilai Matematika Semester 2.2", 65.0, 100.0)
